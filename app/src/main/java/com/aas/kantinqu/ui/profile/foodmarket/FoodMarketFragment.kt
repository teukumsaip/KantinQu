package com.aas.kantinqu.ui.profile.foodmarket
...
import com.aas.kantinqu.ui.profile.ProfileMenuAdapter
import com.aas.kantinqu.ui.profile.ProfileMenuModel

class FoodMarketFragment : Fragment(), ProfileMenuAdapter.ItemAdapterCallback  {
    ...
    fun initDataDummy() {
        ...
        menuArrayList.add(ProfileMenuModel("Terns & Conditions"))
    }
